...
export const Footer = () => {
  ...
  return (
    <>
      <footer className="fixed bottom-[4px] left-1/2 -translate-x-1/2 z-20 bg-white/50 text-[#00588C] py-4 shadow-lg h-[63px] w-[262px] md:w-[1200px] md:h-[80px] bottom-0 rounded-3xl">
