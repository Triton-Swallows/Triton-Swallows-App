...
export const Home = () => {
  return (
    <HeaderLayout transparent>
      <div className="relative h-[756px] bg-[#FAFAFA] overflow-visible sm:h-[756px] h-[680px]">
        <div className="absolute left-0 -top-16 z-0 w-full h-[650px] overflow-hidden">
          <img
            src={topPageImage}
        ...
        <div className="absolute inset-x-0 bottom-14 z-20">
          <div className="mx-auto flex w-full max-w-md flex-col items-center gap-6">
            ...
            <Link to="/country-list" className="w-full max-w-[256px]">
              <Button className="w-[256px] h-[62px] px-4 py-2 bg-[#00588C] rounded-lg shadow-[0px_2px_2px_0px_rgba(0,0,0,0.25)] justify-center items-center text-[#FAF6F0] text-[32px] font-bold">
                旅行の準備する
              </Button>
            </Link>
          </div>
